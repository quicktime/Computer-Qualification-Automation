...
[-] testcase VerifyResults() appstate none
	...
	[ ] 
	[-] while (DB_FetchNext (hResult, rExpectedDisc))
		[ ] 
		[ ] rExpected.sSampleID = rExpectedDisc.sSampleID  
		[ ] rExpected.sStatus = rExpectedDisc.sStatus		 
		[ ] rExpected.sErrorStatus = rExpectedDisc.sErrorStatus 
		[ ] rExpected.sAssayName = rExpectedDisc.sAssayName
		[ ] rExpected.sResultText = rExpectedDisc.sResultText
		[ ] rExpected.sResultColor = rExpectedDisc.sResultColor
		[ ] rExpected.sResultFont = rExpectedDisc.sResultFont 
		[ ] rExpected.iPosition = rExpectedDisc.iPosition
		[ ] 
		...
		[ ] 
		[ ] // Verify the test disclaimer 
		[ ] VerifyTestDisclaimer (rExpectedDisc)
		[ ] print('---------------------------------------------------------------------------')
		[ ] print()
		[ ] 
		[-] if rExpected.sSampleID != sPrevSampleID
